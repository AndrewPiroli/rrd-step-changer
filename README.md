...
A lovely script bundled with a certian network monitoring system that changes RRD step values in the header without touching the records, which destorys the timescale.... thanks.
